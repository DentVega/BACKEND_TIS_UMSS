...
const createOne = async function(req, res, next) {
    ...
    const val = await pool.query('SELECT * from additionalclass where grupohorarios_idgrupohorarios = $1 and falta_idfalta = $2', [grupohorarios_idgrupohorarios,falta_idfalta]);
    res.json({
